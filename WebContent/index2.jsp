...
%>
          ...
          <li><a href="user/moviehome.jsp"><img style="width:450px;height:350px;display:block;margin-left:auto;margin-right:auto;" src="user/<%=str1 %>" alt="" /></a></li>
                <%
                k--;
}
        %>
...
<div class="footer">
  <div class="shell">
    ...
    <p class="rf"><a href=""></a> <a href="http://www.youtube.com/watch?v=Y7PhzJRaBiQ" target="_blank"> </a></p>
